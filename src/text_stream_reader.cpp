...
#include "readers/bom_stream_reader.h"
#include "readers/mapped_stream_reader.h"
#include "readers/utf8_stream_reader.h"
#include "readers/utf16le_stream_reader.h"
#include "readers/utf16be_stream_reader.h"
#include "readers/utf32le_stream_reader.h"
#include "readers/utf32be_stream_reader.h"
...
std::unique_ptr<TextStreamReader> TextStreamReader::open(std::istream& in, Charset cs)
{
    ...
    {
    case Charset::CP_437:
        reader.reset(new MappedStreamReader(in, MAPPING_CP_437));
        break;
    case Charset::CP_850:
        reader.reset(new MappedStreamReader(in, MAPPING_CP_850));
        break;
    case Charset::CP_1252:
        reader.reset(new MappedStreamReader(in, MAPPING_CP_1252));
        break;
    case Charset::ISO_8859_15:
        reader.reset(new MappedStreamReader(in, MAPPED_ISO_8859_15));
        break;
    case Charset::UTF_8:
        reader.reset(new Utf8StreamReader(in));
        break;
    case Charset::UTF_16_LE:
        reader.reset(new Utf16LeStreamReader(in));
        break;
    case Charset::UTF_16_BE:
        reader.reset(new Utf16BeStreamReader(in));
        break;
    case Charset::UTF_32_LE:
        reader.reset(new Utf32LeStreamReader(in));
        break;
    case Charset::UTF_32_BE:
        reader.reset(new Utf32BeStreamReader(in));
        break;
    case Charset::UTF_8_BOM:
        reader.reset(new BomStreamReader<Utf8StreamReader, ByteOrderMark::BOM_UTF8.size()>(in, ByteOrderMark::BOM_UTF8));
        break;
    case Charset::UTF_16_LE_BOM:
        reader.reset(new BomStreamReader<Utf16LeStreamReader, ByteOrderMark::BOM_UTF16_LE.size()>(in, ByteOrderMark::BOM_UTF16_LE));
        break;
    case Charset::UTF_16_BE_BOM:
        reader.reset(new BomStreamReader<Utf16BeStreamReader, ByteOrderMark::BOM_UTF16_BE.size()>(in, ByteOrderMark::BOM_UTF16_BE));
        break;
    case Charset::UTF_32_LE_BOM:
        reader.reset(new BomStreamReader<Utf32LeStreamReader, ByteOrderMark::BOM_UTF32_LE.size()>(in, ByteOrderMark::BOM_UTF32_LE));
        break;
    case Charset::UTF_32_BE_BOM:
        reader.reset(new BomStreamReader<Utf32BeStreamReader, ByteOrderMark::BOM_UTF32_BE.size()>(in, ByteOrderMark::BOM_UTF32_BE));
        break;
    default:
...
char32_t TextStreamReader::peek()
{
    if (next_ == EOF)
    {
        next_ = get();
