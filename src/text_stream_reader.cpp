...
static const std::vector<uint8_t> BOM_UTF8     = {0xEF, 0xBB, 0xBF};
static const std::vector<uint8_t> BOM_UTF16_LE = {0xFF, 0xFE};
static const std::vector<uint8_t> BOM_UTF16_BE = {0xFE, 0xFF};
static const std::vector<uint8_t> BOM_UTF32_LE = {0xFF, 0xFE, 0x00, 0x00};
static const std::vector<uint8_t> BOM_UTF32_BE = {0x00, 0x00, 0xFE, 0xFF};

static const std::unordered_map<int32_t, char32_t> MAPPING_CP_437 =
{
                                                                                                                    {0x7F, 0x2302},
...
static const std::unordered_map<int32_t, char32_t> MAPPING_CP_850 =
{
                                                                                                                    {0x7F, 0x2302},
    {0x80, 0x00C7}, {0x81, 0x00FC}, {0x82, 0x00E9}, {0x83, 0x00E2}, {0x84, 0x00E4}, {0x85, 0x00E0}, {0x86, 0x00E5}, {0x87, 0x00E7},
    {0x88, 0x00EA}, {0x89, 0x00EB}, {0x8A, 0x00E8}, {0x8B, 0x00EF}, {0x8C, 0x00EE}, {0x8D, 0x00EC}, {0x8E, 0x00C4}, {0x8F, 0x00C5},
...
static const std::unordered_map<int32_t, char32_t> MAPPING_CP_1252 =
{
                                                                                                                    /*   0x7F   */
...
static const std::unordered_map<int32_t, char32_t> MAPPED_ISO_8859_15 =
{
                                                                                                                    /*   0x7F   */
...
std::unique_ptr<TextStreamReader> TextStreamReader::open(std::istream& str, Charset cs)
{
    std::unique_ptr<TextStreamReader> reader;
    switch (cs)
    {
    case Charset::CP_437:
        reader.reset(new MappedStreamReader(str, MAPPING_CP_437));
        break;
    case Charset::CP_850:
        reader.reset(new MappedStreamReader(str, MAPPING_CP_850));
        break;
    case Charset::CP_1252:
        reader.reset(new MappedStreamReader(str, MAPPING_CP_1252));
        break;
    case Charset::ISO_8859_15:
        reader.reset(new MappedStreamReader(str, MAPPED_ISO_8859_15));
        break;
    case Charset::UTF_8:
        reader.reset(new Utf8StreamReader(str));
        break;
    case Charset::UTF_16_LE:
        reader.reset(new Utf16LeStreamReader(str));
        break;
    case Charset::UTF_16_BE:
        reader.reset(new Utf16BeStreamReader(str));
        break;
    case Charset::UTF_32_LE:
        reader.reset(new Utf32LeStreamReader(str));
        break;
    case Charset::UTF_32_BE:
        reader.reset(new Utf32BeStreamReader(str));
        break;
    case Charset::UTF_8_BOM:
        reader.reset(new BomStreamReader<Utf8StreamReader>(str, BOM_UTF8));
        break;
    case Charset::UTF_16_LE_BOM:
        reader.reset(new BomStreamReader<Utf16LeStreamReader>(str, BOM_UTF16_LE));
        break;
    case Charset::UTF_16_BE_BOM:
        reader.reset(new BomStreamReader<Utf16BeStreamReader>(str, BOM_UTF16_BE));
        break;
    case Charset::UTF_32_LE_BOM:
        reader.reset(new BomStreamReader<Utf32LeStreamReader>(str, BOM_UTF32_LE));
        break;
    case Charset::UTF_32_BE_BOM:
        reader.reset(new BomStreamReader<Utf32BeStreamReader>(str, BOM_UTF32_BE));
        break;
    default:
...
std::u32string TextStreamReader::read(size_t n)
{
    ...
    while (result.length() < n && peek() != EOF)
    {
